...
if(isset($_POST["save"])){
    $ques =new question($_POST['titre'],$_POST['descriptionn'],$_POST['contenu']);

    $pc->updatequestion($_POST['id'],$ques);
...
<div >
    ...
    <input type="text" class="form-control" name="titre" value="<?php echo $p['titre'];?>">
</div>
<div >
    <label for="exampleInputEmail1" class="form-label">Description de la question</label>
    <textarea class="form-control" name="descriptionn"value="<?php echo $p['descriptionn'];?>"></textarea>
</div>
<div>
    <label for="exampleInputEmail1" class="form-label">Contenu de la question</label>
    <textarea type="text" class="form-control" name="contenu" value="<?php echo $p['contenu'];?>" ></textarea>
</div>
